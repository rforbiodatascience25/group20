...
Now let's look at which of the nine biopsy measurements actually drive the
principal components. The loadings show us how much each variable contributes
to each PC, helping us understand what the components actually represent.
...
pca_fit %>%
  ...
  geom_text_repel(aes(label = column), size = 3.5, max.overlaps = 20) +
  theme_minimal_grid() +
